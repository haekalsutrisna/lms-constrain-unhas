...
<head>
    ...
    <title>CBT - CONSTRAIN 2024</title>
...
<body class="text-center">
    ...
    <form class="form-signin" action="<?= $homeurl ?>/mobile_login.php" method="POST" name="login" style="z-index: 2;">
        <img class="mb-4" src="<?= $homeurl ?>/dist/img/constrain.png" alt="" width="130" height="140">
        <h1 class="h3 mb-3 font-weight-normal">CONSTRAIN 2024</h1>
